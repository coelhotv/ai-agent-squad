...
1. **LLM Host (macOS):** Ollama runs outside Docker to keep GPU access to the M2’s Metal cores. The default model is `deepseek-r1:7b-qwen-distill-q4_K_M`, and the UI communicates with it via `http://host.docker.internal:11434`.
