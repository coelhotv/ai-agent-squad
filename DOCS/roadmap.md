...
- Ollama model switched to `deepseek-r1:14b-qwen-distill-q4_K_M`, and we now pair it with `qwen2.5-coder:14b-instruct-q4_K_M` for coding-intensive specialists.
